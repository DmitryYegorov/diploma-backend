...
-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('LECTION', 'PRACTICE_CLASS', 'LAB', 'CONSULTATION', 'COURSE_WORK', 'EXAM', 'CREDIT', 'POSTGRADUATE', 'TESTING', 'PRACTICE', 'DISPLOMA_DESIGN', 'STATE_EXAMINATION_BOARD');
